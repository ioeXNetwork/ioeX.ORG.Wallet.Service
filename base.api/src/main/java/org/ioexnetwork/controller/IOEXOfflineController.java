...
import org.ioexnetwork.entity.HdTxEntity;
import org.ioexnetwork.entity.RawTxEntity;
 ...
 */
@RestController
public class IOEXOfflineController extends BaseController{

    private Logger logger = LoggerFactory.getLogger(IOEXOfflineController.class);
